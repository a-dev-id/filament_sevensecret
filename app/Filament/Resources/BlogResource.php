            ...
            ->schema([
                ...
                Grid::make()->schema([
                    Section::make('Image')
                        ->schema([
                            Grid::make(2)->schema([
                                FileUpload::make('banner_image')->label('Header Image')->directory('storage/blog/header'),
                                FileUpload::make('cover_image')->label('Cover Image')->directory('storage/blog/cover'),
                            ]),
                        ])
                        ->collapsible()
                        ->compact(),
