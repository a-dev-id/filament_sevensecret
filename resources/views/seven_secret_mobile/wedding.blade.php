...
<x-seven-secret-mobile>
    <div class="wrapper page">
                ...
                <div class="row">
                    <div class="col-12 py-3">
                        ...
                        <div class="button-wrapper text-center">
                            <button type="button" class="btn btn-custom w-100 py-2" data-bs-toggle="modal" data-bs-target="#spa-modal">
                                Inquire Now
                            </button>
                        </div>
                    </div>
        ...
        <!-- Inquiry Modal -->
        <div class="modal fade" id="spa-modal" tabindex="-1" aria-labelledby="spa-modalLabel" aria-hidden="true">
            <form class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm" method="post" action="{{route('inquiry.store')}}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title text-uppercase" id="spa-modalLabel">Inquiry Form</h2>
