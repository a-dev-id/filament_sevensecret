                    ...
                    <form class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" method="post" action="{{route('inquiry.store')}}">
                        ...
                        <div class="modal-content">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="col-12">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 col-md-6 mb-2">
                                                <label for="reserveddate_enquiry_wedding" class="form-label">Reserved Date<span class="text-danger">*</span></label>
                                                <div class="input-group rounded-0">
                                                    <span class="input-group-text rounded-0 px-3"><i class="fa fa-calendar" style="width: 16px;"></i></span>
                                                    <input type="text" class="datepicker form-control rounded-0" name="date" id="reserveddate_enquiry_wedding" required="true" readonly="true">
                                                </div>
                                            </div>
                                            @push('js')
                                            <script>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-sm btn-outline-primary text-uppercase py-2 px-3 rounded-0 me-2" data-bs-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-primary text-uppercase rounded-0 py-2 px-3 btn-sm fw-bold">Inquire Now</button>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary text-uppercase rounded-0 py-2 px-3 btn-sm fw-bold" data-bs-toggle="modal" data-bs-target="#{{'modalinquiry'.$data->id}}">
                                        {{ $data->button_text }}
                                    </button>
                                </div>
                            </div>
