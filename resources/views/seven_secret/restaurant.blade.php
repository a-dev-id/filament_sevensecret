            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 border-end border-secondary">
                    <div class="mb-3">
                        ...
                        <p class="fs-6 fw-bold mb-0">International and Indonesian</p>
                    </div>
                    <div class="mb-3">
                        <h4 class="text-uppercase mb-0" style="font-size: 12px;">Operationg Hour</h4>
                        <p class="fs-6 fw-bold mb-0">7am to 9pm</p>
                    </div>
                    <div class="mb-3">
                        <h4 class="text-uppercase mb-0" style="font-size: 12px;">Contact</h4>
                        <p class="fs-6 fw-bold mb-0">
                            <a href="mailto:reservations@sevensecretsresorts.com" class="link-dark text-decoration-none d-block mb-0">reservations@sevensecretsresorts.com</a>
                ...
                <div class="container">
                    <div class="row">
                        @if($loop->iteration % 2 == 0) <div class="col-12 col-md-5 d-flex flex-column justify-content-between order-2"> @else <div class="col-12 col-md-5 d-flex flex-column justify-content-between order-1"> @endif
                                <div class="pe-3">
                                    <h2 class="text-uppercase mb-3 fw-bold">{{$data->title}}</h2>
                                ...
                                <div class="pe-3">
                                    ...
                                    <button type="button" @if($loop->iteration % 2 == 0)
                                        ...
                                        @endif
                                        data-bs-target="#{{'modalinquiry'.$data->id}}">
                                        {{ $data->button_text }}
                                    </button>
